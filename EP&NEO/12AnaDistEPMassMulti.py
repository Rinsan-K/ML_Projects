...
# ------------Analyze the distribution of exoplanets' mass multipliers----------

plt.figure(figsize=(10, 5))
sns.histplot(exoplanets_data['mass_multiplier'], bins=50, kde=True)
plt.xlabel('Mass Multiplier')
plt.ylabel('Count')
plt.title('Distribution of Exoplanets Mass Multipliers')
plt.xlim(0, 50)
