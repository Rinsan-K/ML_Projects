...
# -------K-Nearest Neighbors Classifier for Exoplanet Classification and ROC Analysis---------
...
y_train_neo_class = (y_train_neo_encoded >= 0.5).astype(int)
y_test_neo_class = (y_test_neo_encoded >= 0.5).astype(int)
...
# Generate ROC Curve
y_true_neo = y_test_neo_class
y_prob_neo = model.predict_proba(X_test_neo)[:, 1]
model_name = 'KNN'

false_positive_rate, true_positive_rate, thresholds = roc_curve(y_true_neo, y_prob_neo)
