...
# ---------Top 5 most common detection methods for exoplanets----------

detection_methods = exoplanets_data['detection_method'].value_counts().head(5)
print("Top 5 most common detection methods for exoplanets:")
print(detection_methods)

exoplanets_data['detection_method'].value_counts().plot.barh();